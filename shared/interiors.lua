...
--- Slot positions use TODO_COORDS until exact vec4 data is confirmed.
Interiors.Templates = {
    low_2_car_garage = {
        id = 'low_2_car_garage',
        ...
        ipl = nil,
        shellModel = nil,
        entryCoords = 'TODO_COORDS_VEC4',
        exitCoords = 'TODO_COORDS_VEC4',
        cameraCoords = 'TODO_COORDS',
        vehicleSlots = {},
        bicycleSlots = {},
        slotLayout = {
            { index = 1, type = 'vehicle', floor = 1, coords = 'TODO_COORDS_VEC4' },
            { index = 2, type = 'vehicle', floor = 1, coords = 'TODO_COORDS_VEC4' },
            { index = 3, type = 'bicycle', floor = 1, coords = 'TODO_COORDS_VEC4' },
        },
        style = 'basic',
    },
